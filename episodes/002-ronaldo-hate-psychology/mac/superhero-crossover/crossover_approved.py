...
# Precomputed from the approved outline in Blender 4.5. Runtime tessellation
# caused Blender 5.2 on macOS to abort with SIGTRAP before Python could report it.
