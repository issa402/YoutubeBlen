...
2026-09-05 update: `WORKFLOW_BLUEPRINT.md` supersedes the initial recommendations below where they differ. Codex is the immediate coordinator; Hermes is conditional. Trial whisper.cpp before adopting a heavier ASR stack. Tools listed here are planned roles, not verified installations.
